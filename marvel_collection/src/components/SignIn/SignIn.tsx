...
export const SignIn = (props: userProps) => {
    ...
    return (
        <Container maxWidth='sm' sx={signinStyles.containerStyle}>
            ...
            <Snackbar message='success' open={alertOpen} autoHideDuration={2000}  onClose={navToDash}>
                <div>
                    <Alert severity='success'>
                        <AlertTitle>Successful Sign In --- Redirect in 2 seconds</AlertTitle>
                    </Alert>
                </div>
            </Snackbar>
        </Container>
...
export const SignUp = (props: userProps) => {
    ...
    return (
        <Container maxWidth='sm' sx={signinStyles.containerStyle}>
            ...
            <Snackbar message='success' open={alertOpen} autoHideDuration={2000} onClose={handleSnackClose}>
                <div>
                    <Alert severity='success'>
                        <AlertTitle>Successful Sign Up --- Redirect in 2 seconds</AlertTitle>
                    </Alert>
                </div>
            </Snackbar>
        </Container>
